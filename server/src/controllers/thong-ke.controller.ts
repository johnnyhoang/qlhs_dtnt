...
export const layThongKeSuatAnCatTheoLopVaNgay = async (req: Request, res: Response) => {
    try {
        ...
        const result = await ThongKeService.getMealCutoffByClassAndWeek(start_date, end_date);
        res.json(result);
    } catch (error) {
...
export const layThongKeSuatAnTheoThang = async (req: Request, res: Response) => {
    try {
        ...
        const result = await ThongKeService.getMonthlyMealStatistics(month, year);
        res.json(result);
    } catch (error) {
...
export const layThongKeVanChuyenTheoLop = async (req: Request, res: Response) => {
    try {
        ...
        const result = await ThongKeService.getTransportStatisticsByClass(start_date, end_date);
        res.json(result);
    } catch (error) {
